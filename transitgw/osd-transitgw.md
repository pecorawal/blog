...
!(/transitgw/images/1-create-private-vpc-clusterside.png))["VPC Cluster Side"]
...
```
!(/transitgw/images/3-private-subnet-vpc.png)[Cluster Private Subnet]
...
!(/transitgw/images/2-create-vpc-customerside.png)["VPC Customer AWS Subscription"]
...
```
!(/transitgw/images/4-private-subnet-Egressvpc.png)[Egress VPC - Private Subnet]
...
```
!(/transitgw/images/5-public-subnet-Egressvpc.png)[Egress VPC - Public Subnet]
...
!(/transitgw/images/6-igw.png)[Internet Gateway]
...
!(/transitgw/images/7-natgw.png)[Nat Gateway]
...
```
!(/transitgw/images/9-attachment-tgw-cluster.png)[Attachment for Transit GW and Cluster VPC]
...
!(/transitgw/images/10-attachment-tgw-egress.png)[Attachment for Transit GW and Egress VPC]
...
!(/transitgw/images/11-tgw-defaultroute.png)[Transit Gw Default Route]
...
```
!(/transitgw/images/12-egresspublic-igw-table.png)[Static Route to Egress Public Subnet for Internet Traffic]
...
!(/transitgw/images/13-egresspublic-natgw-table.png)[Route table to egress private Nat Gateway]
...
!(/transitgw/images/full-diagram.png)[Openshift Dedicated Private Cluster with Transit Gateway]
